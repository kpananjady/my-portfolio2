...
let svg = d3
  ...
  function ready(dummydata) {
    ...
    svg.append('text').attr('class', 'sub-title').text('identified themselves as uncommitted, but the President won at least').attr('alignment-baseline', 'middle').attr('y',115).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
    svg.append('text').attr('class', 'sub-title').text("60% of the GOP vote in every one of the state's 169 towns.").attr('alignment-baseline', 'middle').attr('y',135).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
