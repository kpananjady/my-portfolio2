...
let svg = d3
  ...
  function ready(dummydata) {
    ...
    svg.append('text').attr('class', 'sub-title').text('are reporting data. Results were last updated at 10:30 a.m.').attr('alignment-baseline', 'middle').attr('y',95).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
