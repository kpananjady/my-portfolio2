...
let svg = d3
  ...
  function ready(dummydata) {
    ...
    svg.append('text').attr('class', 'title').text("2020's dramatic drop in prison admissions").attr('alignment-baseline', 'middle').attr('y',20).attr('font-size', '25px').attr('font-weight', 5).attr('x', 0)
    svg.append('text').attr('class', 'title').text("has sustained the overall population decline").attr('alignment-baseline', 'middle').attr('y',45).attr('font-size', '25px').attr('font-weight', 5).attr('x', 0)
    ...
    svg.append('text').attr('class', 'sub-title').text("The bars represent admissions, discretionary releases, end of sentence (EOS)").attr('alignment-baseline', 'middle').attr('y',75).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
    svg.append('text').attr('class', 'sub-title').text("releases and special parole as a percentage of the sentenced population.").attr('alignment-baseline', 'middle').attr('y',95).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
