...
let svg = d3
  ...
  function ready(dummydata) {
    svg.append('text').attr('class', 'title').text("2020's unequal recession").attr('alignment-baseline', 'middle').attr('y',45).attr('font-size', '25px').attr('font-weight', 5).attr('x', 0)
...
svg.append('circle').attr('r',5).attr('cx', 50).attr('cy', 140).attr('fill', 'darkgreen').attr('opacity', 0.5)
    ...
    svg.append('text').text("Initial claims (Not necessarily granted)").attr('alignment-baseline', 'middle').attr('y',140).attr('x',75).attr('font-size', '10px').attr('font-weight', 5)
    svg.append('text').text("Continued claims").attr('alignment-baseline', 'middle').attr('y',120).attr('x',75).attr('font-size', '10px').attr('font-weight', 5)
