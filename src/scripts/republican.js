...
svg.append('text').attr('class', 'graph_name').text('2020: 29.78%').attr('alignment-baseline', 'center').attr('y',-100).attr('x',-50).attr('font-size', '10px').attr('font-weight', 5)
svg.append('text').attr('class', 'graph_name').text('2020:20.20%').attr('alignment-baseline', 'left').attr('y',-60).attr('x',-50).attr('font-size', '10px').attr('font-weight', 5)

svg.append('circle').attr('id', 'dot_plot1').attr('r', 6).attr('cy',-100).attr('cx', xPositionScale2(43.1)).attr('fill', 'lightgrey')
svg.append('circle').attr('id', 'dot_plot2').attr('r', 6).attr('cy',-100).attr('cx', xPositionScale2(29.78)).attr('fill', 'black')
...
.attr('id', 'my_line1')
  ...
  .attr("x1", function(d) { return xPositionScale2(29.78) })
...
svg.append('circle').attr('id', 'dot_plot4').attr('r', 6).attr('cy',-60).attr('cx', xPositionScale2(20.20)).attr('fill', 'black')
...
.attr('id', 'my_line2')
  ...
  .attr("x1", function(d) { return xPositionScale2(20.20) })
...
svg
         ...
         svg.append('text').attr('class', 'label').text('42%').attr('alignment-baseline', 'middle').attr('y',-57).attr('x',2*0.4*width+30).attr('font-size', '10px').attr('font-weight', 5)
  ...
  svg
    ...
    function render() {
      ...
      .attr("x1", function(d) { return xPositionScale2(20.20) })
        ...
        svg.select('#dot_plot2').attr('cx', xPositionScale2(29.78))
        svg.select('#dot_plot3').attr('cx', xPositionScale2(47.2))
        svg.select('#dot_plot4').attr('cy',-60).attr('cx', xPositionScale2(20.20))
        ...
        svg.select('.bar_2_state').attr("x", 0.4*newWidth+60).attr('width', (42/100)*0.4*newWidth)
