...
svg.append('text').attr('class', 'sub-title').text('Percentage of eligible 65 and over people who received a 1st dose by town.').attr('alignment-baseline', 'middle').attr('y',75).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
       ...
       d3.select('#toggle2').on('click', () => {
        ...
        svg.append('text').attr('class', 'title').text("50 prioritized zipcodes").attr('alignment-baseline', 'middle').attr('y',45).attr('font-size', '25px').attr('font-weight', 5).attr('x', 0)
        svg.append('text').attr('class', 'sub-title').text("A fourth of the state's vaccines to go to vulnerable zipcodes").attr('alignment-baseline', 'middle').attr('y',75).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
        
    })


        // sv g.append('text').attr('class', 'sub-title').text('Cities lag despite concentrations of vaccination clinics.').attr('alignment-baseline', 'middle').attr('y',95).attr('font-size', '20px').attr('font-weight', 5).attr('x', 0)
