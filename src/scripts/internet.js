...
Promise.all([
  ...
  function ready([json2, json, internet]) {
    ...
    svg.append('text').attr('id', 'box1-text').text('0').attr('x',width-220).attr('y', height-200).attr('font-size', 10)
      ...
      svg.append('rect').attr('id', 'box0-m').attr('width', 25).attr('height', 5).attr('x',width-175).attr('y', height-200).style('fill', 'white').attr('opacity',0.3)
      svg.append('rect').attr('id', 'box1-m').attr('width', 25).attr('height', 5).attr('x',width-150).attr('y', height-200).style('fill', 'white').attr('opacity',0.3)
      svg.append('rect').attr('id', 'box2-m').attr('width', 25).attr('height', 5).attr('x',width-125).attr('y', height-200).style('fill', 'white').attr('opacity',0.3)
      svg.append('rect').attr('id', 'box3-m').attr('width', 25).attr('height', 5).attr('x',width-100).attr('y', height-200).style('fill', 'white').attr('opacity',0.3)
      svg.append('rect').attr('id', 'box4-m').attr('width', 25).attr('height', 5).attr('x',width-75).attr('y', height-200).style('fill', 'white').attr('opacity',0.3)
